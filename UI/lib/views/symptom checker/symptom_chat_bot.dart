...
import 'package:test/core/services/symptom%20chat%20service/chat_services.dart';
...
class SymptomChatBot extends StatefulWidget {
  const SymptomChatBot({super.key});

  @override
  State<SymptomChatBot> createState() => _ChatBotState();
}

class _ChatBotState extends State<SymptomChatBot> {
  ...
  Future<void> _sendMessage(BuildContext context) async {
    if (_messageHasData && !_isLoading) {
      ...
      final symptomChatServices =
          SymptomChatService(chatIdProvider, chatHistoryProvider);
      await symptomChatServices.askAssitant(
        {
  ...
  Widget build(BuildContext context) {
    final chatHistoryProvider =
        Provider.of<SymptomChatHistoryProvider>(context);
    List<ChatMessage> chatHistory = chatHistoryProvider.symptomChatHistory;
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color(0xff9169C1).withOpacity(0.4),
                  borderRadius: BorderRadius.circular(20.0.dm),
                ),
