...
class WomenHealthChatService {
  final WomenHealthChatIdProvider chatIdProvider;
  final WomenHealthChatHistoryProvider chatHistoryProvider;

  WomenHealthChatService(this.chatIdProvider, this.chatHistoryProvider);

  Future<void> askAssitant(
      Map<String, dynamic> body, BuildContext context) async {
    final chatId = chatIdProvider.womenHealthChatId;
    String url =
