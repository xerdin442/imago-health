...
class SymptomCompleteChatHistory {
  ...
  Future<void> getChatHistory(BuildContext context) async {
    final chatIdProvider = Provider.of<SymptomChatIdProvider>(context, listen: false);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        chatHistoryProvider.setSymptomChatHistory(chatHistory);
      } else {
